...
export default function MainFooter() {
    return (
        <footer className="w-full py-14 bg-[#F7F7F7] shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] relative z-50">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    {/* Logo */}
                    <div className="pl-5 w-fit pt-2.5 pb-2.5 xl:p-0 m-auto">
                        <Link href={"/"}>
                            <Image src="/images/logo.png" alt="YourBrand Logo" width={150} height={50} />
                        </Link>
                    </div>

                    {/* Nav Links */}
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li><Link href="/" className="font-heading text-gray-800 hover:text-[var(--red)]">Home</Link></li>
                        <li><Link href="/about" className="font-heading text-gray-800 hover:text-[var(--red)]">About</Link></li>
                        <li><Link href="/product" className="font-heading text-gray-800 hover:text-[var(--red)]">Our products</Link></li>
                        <li><Link href="/contact" className="font-heading text-gray-800 hover:text-[var(--red)]">Contact Us</Link></li>
                    </ul>

                    {/* Social Icons */}
                    <div className="flex space-x-10 justify-center items-center mb-10">
                        {/* social icons ... (kept same as yours) */}
                        <Link href="/" target='_blank' className="block text-gray-900 transition-all duration-500 hover:text-[var(--red)] ">
                            {/* X / Twitter */}
                        ...
                        {/* Facebook */}
                        <Link href="https://web.facebook.com/profile.php?id=61570858629725" target='_blank' className="block text-gray-900 transition-all duration-500 hover:text-[var(--red)] ">
                    ...
                    <div className="text-center mb-14">
                        <p className="text-lg text-gray-700">
                            📞 <Link href="tel:+94772890959" className="hover:text-[var(--red)]">+94 77 289 0959</Link>
                        </p>
                        <p className="text-lg text-gray-700">
                            📧 <Link href="mailto:info@villsdairy.com" className="hover:text-[var(--red)]">info@villsdairy.com</Link>
                        </p>
                    </div>
                    ...
                    <span className="text-lg text-gray-500 text-center block">
                        ...
                        <Link href="https://weblab.lk/" className="text-[18px] tracking-[5px] font-bold hover:text-[var(--red)]">
                            WEBLAB
                        </Link>
                    </span>
                </div>
